...
if __name__ == '__main__':
    ...
    motor_ra = motor_control.MotorControl(bus=0, cs_pin = 0, slave_pin=25, reset_pin = 3, 
    ...
    motor_dec = motor_control.MotorControl(bus=1, cs_pin = 0, slave_pin=12, reset_pin = 3, 
